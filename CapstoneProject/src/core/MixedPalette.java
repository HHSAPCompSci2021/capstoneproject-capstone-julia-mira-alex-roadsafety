...
public class MixedPalette extends Palette{
	...
	//	shades = new PaintButton[5]; 
		...
		//shades[0] = ; 
		collection.add(new PaintButton( new Rectangle(10, 100, 750, 100), "X", new Paint(newc, 0))); 
		collection.add(new PaintButton( new Rectangle(110, 100, 75, 100), "X", new Paint(newc2, 0))); 
